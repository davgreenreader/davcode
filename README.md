...
The above apps can be prebuilt with Expo using the following commands:
...
``
open ios/GreenReader.xcworkspace
``


This will bring you to Xcode. Here you can build the app, install on your physical iPhone or distribute to the iOS Store (assuming you have a paid Apple Developer account).
