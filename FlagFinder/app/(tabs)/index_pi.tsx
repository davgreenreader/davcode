...
export default function FlagFinderScreen() {
  ...
  if (!hasPermission) {
    return (
      <View style={styles.centered}>
        <Text style={styles.titleText}>Device Connection Required</Text>
        <Text style={styles.subtitleText}>
          Flag Finder needs to be connected to the device to detect the tag on the flag.
        </Text>
        <TouchableOpacity style={styles.primaryBtn} onPress={connectBluetooth()}>
  ...
  if (!device) {
    return (
      <View style={styles.centered}>
        <Text style={styles.titleText}>No Device Found</Text>
      </View>
    );
  }
